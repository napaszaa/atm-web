...
public class CustomerRepository implements JdbcRepository {
    ...
    public List<Customer> findAll() {
        ...
        return customers;
      //  return jdbcTemplate.query(query, new CustomerMapper());   ใช้แบบนี้แทนบรรทัดที่ 20-22 เลยก็ได้
    }
    ...
    public Customer findById(int id) {
        ...
        return customer;
      //  return jdbcTemplate.queryForObject(query, new CustomerMapper()); ใชแทนบรรทัดที่ 29-31 ได้เลยก็ได้
    }
